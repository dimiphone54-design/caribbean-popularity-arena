...
export const arenaCreators: ArenaCreatorSlot[] = [
  {
    ...
    category: "Reggaeton",
    categoryIcon: "🎵",
    quote: "Soy Isabella — Bogotá suena distinto cuando estoy en vivo.",
    language: "",
    likes: 0,
    comments: 0,
  ...
  },
  {
    ...
    category: "Flamenco",
    categoryIcon: "💃",
    quote: "Desde Barcelona — fuego, ritmo y pasión.",
    language: "Spanish",
    likes: 0,
    comments: 0,
    portrait: { skin: "#c4916a", hair: "#1d0f0d", outfit: "#c084fc", accent: "#ef4444" },
    avatarIcon: "💃",
