...
import { cleanBasketballDisplayTitle, youtubeThumbnail } from "@/lib/sports-highlight-youtube";
...
export function CfaNavBasketballRecapSlideshow() {
  ...
  if (!activeClip) {
    return (
      <div className="cfa-football-pitch-slideshow cfa-football-pitch-slideshow--empty">
        <p>No recent basketball games</p>
      </div>
    );
  }

  const displayTitle = cleanBasketballDisplayTitle(activeClip.title);

  return (
    <div className="cfa-football-pitch-slideshow" aria-label="Basketball - Recaps highlight slideshow">
