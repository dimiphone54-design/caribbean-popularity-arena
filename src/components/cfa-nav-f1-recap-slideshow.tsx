...
import { cleanF1DisplayTitle, youtubeThumbnail } from "@/lib/sports-highlight-youtube";
...
export function CfaNavF1RecapSlideshow() {
  ...
  if (!activeClip) {
    return (
      <div className="cfa-football-pitch-slideshow cfa-football-pitch-slideshow--empty">
        <p>No recent grand prix recaps</p>
      </div>
    );
  }

  const displayTitle = cleanF1DisplayTitle(activeClip.title);

  return (
    <div
      className="cfa-football-pitch-slideshow cfa-f1-recap-slideshow"
      aria-label="F1 - Recaps highlight slideshow"
    >
      <div className="cfa-football-pitch-slideshow-reel" aria-hidden="true">
        ...
        <div className="cfa-football-pitch-slideshow-veil cfa-f1-recap-slideshow-veil" />
        <div className="cfa-football-pitch-slideshow-grain" />
      </div>

      <div className="cfa-football-pitch-slideshow-hud cfa-f1-recap-slideshow-hud">
        ...
        <div className="cfa-football-pitch-slideshow-dots">
          {clips.map((clip, clipIndex) => (
            <span
              key={clip.id}
              className={`cfa-football-pitch-slideshow-dot cfa-f1-recap-slideshow-dot${
